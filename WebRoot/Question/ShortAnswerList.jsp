	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ListTable').datagrid({
				...
				//width:1160,
				fitColumns:true,
				url:'shortAnswer/searchShortAnswer.do?type=5',
  ...
  <body>
	...
	<div id="shortAnswerDetail">
			...
			<tr>
				...
				<tr>
					<td style="text-align: right;">参考答案：</td>
					<td colspan="5">
						<textarea id="answer" name="answer" style="width: 450px; resize:none; border:1px solid #95B8E7; font-size: 14px; font-family:'微软雅黑'"></textarea>
					</td>
				</tr>
				<tr>
