...
<script type="text/javascript">
	...
	function searchProblem() {
		$('#searchForm').form('submit', {
			...
			success : function(data) {
				...
				queryParams.s_username = $("#s_username").val();
				queryParams.s_type = $("#s_type").combobox("getValue");
				queryParams.s_isclass = $("#s_isclass").val();
	...
	function showAllProblem() {
		...
		queryParams = $('#ListTable').datagrid("options").queryParams;
		//searchProblem();
			 queryParams.s_isShow = "1";
           	 queryParams.s_username = "";
           	 queryParams.s_name = "";
           	 queryParams.s_isclass = "";
           	 queryParams.s_type = "";
		$('#ListTable').datagrid({
			url:'login/searchUsers.do',
			pagination : true,
...
<body>
 ...
 -->
	...
	<div id="toolbar" style="padding-bottom: 10px">
		...
		<form action="" method="post" id="searchForm"
			...
			用户账号：<input type="text" name="s_username" class="inputCls"
				...
				name="s_isclass" class="inputCls" id="s_isclass">&nbsp;
			用户类型：
	...
	<div id="uploadDialog"
		...
		<h4>导入user表 格式如下：*.xlsx</h4>
	     <table  border="1" style="width:90%; margin-left: 20px">
	     	<tr>
	     		<th>username</th>
	     		<th>password</th>
	     		<th>name</th>
	     		<th>type<span>(管理员为1，教员为2，学生为3)</span></th>
	     		<th>isshow<span>(1为使用，0为停用)</span></th>
	     		<th>class<span style:"">(若用户为教员或管理员则为1)</span></th>
